...
window.switchShopTab = function(tab) {
    document.querySelectorAll('.pet-shop-tabs .shop-tab').forEach(t => t.classList.remove('active'));
    var activeTab = document.querySelector('.pet-shop-tabs .shop-tab[data-tab="' + tab + '"]');
